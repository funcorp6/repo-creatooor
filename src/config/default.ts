// Configurations global to invocations of repo-creatooor and repo-doctor,
// meant to keep repository configurations consistent across the organization.
// Do not modify them for a single workflow run
